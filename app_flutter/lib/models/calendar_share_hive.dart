...
class CalendarShareHive extends HiveObject {
  ...
  CalendarShare toCalendarShare() {
    return CalendarShare(
      ...
      permission: CalendarPermission.fromString(permission),
      createdAt: createdAt,
    );
  }

  static CalendarShareHive fromCalendarShare(CalendarShare calendarShare) {
    return CalendarShareHive(
      id: calendarShare.id,
      calendarId: calendarShare.calendarId,
      sharedWithUserId: calendarShare.sharedWithUserId,
      permission: calendarShare.permission.value,
      createdAt: calendarShare.createdAt,
    );
  }
}
