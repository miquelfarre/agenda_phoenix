...
class PlatformWidgets {
  ...
  static Widget platformButton({
    ...
    if (isLoading || isDisabled) {
      ...
      final disabledColor = isLoading || isDisabled
          ? AppStyles.grey300
          : effectiveColor;
      ...
      return SizedBox(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: PlatformDetection.isIOS
                ? Border.all(color: AppStyles.grey200, width: 1)
                : null,
          ),
          child: Center(
            child: isLoading
    ...
    final config = AdaptiveButtonConfig(
      variant: filled ? ButtonVariant.primary : ButtonVariant.secondary,
    ...
    return SizedBox(
      ...
      child: AdaptiveButton(
        config: config,
        onPressed: onPressed,
        text: child is Text ? child.data : null,
      ),
    );
  }
  ...
  static Widget platformSwitch({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: value
              ? (activeColor ?? AppStyles.primary600)
              : AppStyles.grey300,
  ...
  static Widget platformSlider({
    ...
    if (PlatformDetection.isIOS) {
      return CupertinoSlider(
        ...
        max: max,
        divisions: divisions,
        activeColor: activeColor ?? AppStyles.primary600,
      );
    }

    return _NeutralSlider(
      value: value,
      onChanged: onChanged,
      min: min,
      max: max,
  ...
  static Widget platformActionTile({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            backgroundColor ??
            (isIOS ? AppStyles.cardBackgroundColor : AppStyles.grey50),
        borderRadius: BorderRadius.circular(borderRadius),
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              platformIcon(
                icon,
                color: isDestructive ? AppStyles.red600 : AppStyles.primary600,
                size: 24,
              ),
              ...
              if (trailing != null) ...[
                ...
                SizedBox(
                  width: 16,
                  height: 16,
                  child: platformLoadingIndicator(radius: 8),
                ),
              ] else if (showChevron) ...[
                platformIcon(
                  CupertinoIcons.chevron_right,
  ...
  static Widget platformCardContainer({
    required Widget child,
    EdgeInsetsGeometry? padding,
    EdgeInsetsGeometry? margin,
    Color? backgroundColor,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: showBorder
            ? Border.all(
                color: borderColor ?? AppStyles.grey200,
                width: borderWidth,
              )
            : null,
        boxShadow: boxShadow,
  ...
  static Widget platformUserHeader({
            ...
            child: Column(
              ...
              children: [
                ...
                if (badges?.isNotEmpty == true) ...[
                  ...
                  Wrap(spacing: 8, children: badges ?? const []),
                ],
              ],
            ),
          ),
  ...
  static Widget platformBadge({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(borderRadius),
        border: Border.all(
          color: borderColor ?? AppStyles.blueShade100,
          width: 1,
        ),
      ),
      child: Text(
        ...
        style: AppStyles.bodyTextSmall.copyWith(
          ...
          color: textColor ?? AppStyles.blue600,
        ),
      ),
    );
  }

  static Widget platformSeparator({
    double height = 1,
    Color? color,
    EdgeInsetsGeometry? margin,
  }) {
  ...
  static Widget platformRefreshIndicator({
    required Widget child,
...
extension NavigatorStateExtensions on NavigatorState {
  Future<T?> pushScreen<T extends Object?>(
    ...
    return push<T>(
      PlatformNavigation.platformPageRoute<T>(
        builder: (_) => screen,
...
class AdaptiveTimeOfDay {
  ...
  bool operator ==(Object other) {
    ...
    return other is AdaptiveTimeOfDay &&
        other.hour == hour &&
        other.minute == minute;
  }
