...
class ApiClient implements IApiClient {
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchUsers({bool? isPublic, bool? enriched, int? limit, int? offset}) async {
    final result = await get('/users', queryParams: {if (isPublic != null) 'public': isPublic, if (enriched != null) 'enriched': enriched, if (limit != null) 'limit': limit, if (offset != null) 'offset': offset});
  ...
  @override
  Future<Map<String, dynamic>> updateInteraction(int interactionId, Map<String, dynamic> data, {int? currentUserId}) async {
