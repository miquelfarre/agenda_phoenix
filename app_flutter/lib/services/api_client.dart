...
class ApiClient implements IApiClient {
  ...
  Future<Map<String, String>> _getHeaders() async {
    ...
    if (configService.isTestMode && configService.currentUserId != 0) {
      ...
      DebugConfig.info('Added test user ID to request headers: ${configService.currentUserId}', tag: 'API');
      return headers;
    }
  ...
  Uri _buildUri(String path, {Map<String, dynamic>? queryParams}) {
    ...
    if (params.isNotEmpty) {
      final nonNullParams = params.map((key, value) => MapEntry(key, value?.toString()))..removeWhere((key, value) => value == null);
  ...
  dynamic _handleResponse(http.Response response) {
    ...
    DebugConfig.error('API Error: $errorMessage (${response.statusCode})', tag: 'API');

    throw app_exceptions.ApiException(errorMessage, statusCode: response.statusCode);
  }
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchUsers({bool? isPublic, bool? enriched, int? limit, int? offset, String? search}) async {
    final result = await get('/users', queryParams: {if (isPublic != null) 'public': isPublic, if (enriched != null) 'enriched': enriched, if (limit != null) 'limit': limit, if (offset != null) 'offset': offset, if (search != null) 'search': search});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> fetchUser(int userId, {bool? enriched}) async {
    final result = await get('/users/$userId', queryParams: {if (enriched != null) 'enriched': enriched});
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchUserEvents(int userId, {int? currentUserId}) async {
  ...
  @override
  Future<Map<String, dynamic>> updateUser(int userId, Map<String, dynamic> data, {required int currentUserId}) async {
  ...
  @override
  Future<Map<String, dynamic>> subscribeToUser(int userId, int targetUserId) async {
  ...
  @override
  Future<Map<String, dynamic>> createContact(Map<String, dynamic> data, {required int currentUserId}) async {
    final result = await post('/contacts', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateContact(int contactId, Map<String, dynamic> data, {required int currentUserId}) async {
    final result = await put('/contacts/$contactId', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<void> deleteContact(int contactId, {required int currentUserId}) async {
    await delete('/contacts/$contactId');
  }

  @override
  Future<List<Map<String, dynamic>>> fetchEvents({int? ownerId, int? calendarId, int? currentUserId}) async {
    final result = await get('/events', queryParams: {if (ownerId != null) 'owner_id': ownerId, if (calendarId != null) 'calendar_id': calendarId});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> fetchEvent(int eventId, {int? currentUserId}) async {
    final result = await get('/events/$eventId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<List<Map<String, dynamic>>> fetchEventInteractions(int eventId, {int? currentUserId}) async {
    final result = await get('/api/v1/events/$eventId/interactions', queryParams: {});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<List<Map<String, dynamic>>> fetchEventInteractionsEnriched(int eventId, {int? currentUserId}) async {
    final result = await get('/api/v1/events/$eventId/interactions-enriched', queryParams: {});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<List<Map<String, dynamic>>> fetchUserInteractions({int? currentUserId}) async {
    final userId = currentUserId ?? ConfigService.instance.currentUserId;
    final result = await get('/interactions', queryParams: {'user_id': userId.toString(), 'limit': '1000'});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<List<Map<String, dynamic>>> fetchAvailableInvitees(int eventId, {int? currentUserId}) async {
    final result = await get('/events/$eventId/available-invitees', queryParams: {});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<List<Map<String, dynamic>>> fetchEventCancellations({int? currentUserId}) async {
    final result = await get('/events/cancellations', queryParams: {});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> createEvent(Map<String, dynamic> data, {bool force = false}) async {
    final result = await post('/events', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<void> markCancellationViewed(int cancellationId, {int? currentUserId}) async {
    await post('/events/cancellations/$cancellationId/view');
  }

  @override
  Future<Map<String, dynamic>> updateEvent(int eventId, Map<String, dynamic> data, {int? currentUserId, bool force = false}) async {
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchInteractions({int? eventId, int? userId, String? interactionType, String? status, bool? enriched, int? currentUserId}) async {
    final result = await get('/interactions', queryParams: {if (eventId != null) 'event_id': eventId, if (userId != null) 'user_id': userId, if (interactionType != null) 'interaction_type': interactionType, if (status != null) 'status': status, if (enriched != null) 'enriched': enriched});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<List<Map<String, dynamic>>> fetchUserSubscriptions(int userId, {int? currentUserId}) async {
    final result = await get('/users/$userId/subscriptions');
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> fetchInteraction(int interactionId, {int? currentUserId}) async {
    final result = await get('/interactions/$interactionId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> createInteraction(Map<String, dynamic> data, {bool force = false}) async {
    final result = await post('/interactions', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> patchInteraction(int interactionId, Map<String, dynamic> data, {bool force = false}) async {
    final result = await patch('/interactions/$interactionId', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<void> deleteInteraction(int interactionId, {int? currentUserId}) async {
    await delete('/interactions/$interactionId');
  }

  @override
  Future<void> markInteractionRead(int interactionId, {int? currentUserId}) async {
    await post('/interactions/$interactionId/mark-read');
  }

  @override
  Future<List<Map<String, dynamic>>> fetchCalendars({int? ownerId, int? currentUserId}) async {
    final result = await get('/calendars', queryParams: {if (ownerId != null) 'owner_id': ownerId});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> fetchCalendar(int calendarId, {int? currentUserId}) async {
    final result = await get('/calendars/$calendarId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<List<Map<String, dynamic>>> fetchCalendarMemberships(int calendarId, {int? currentUserId}) async {
    final result = await get('/calendars/$calendarId/memberships', queryParams: {});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> createCalendar(Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await post('/calendars', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> addCalendarMembership(int calendarId, Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await post('/calendars/$calendarId/memberships', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateCalendar(int calendarId, Map<String, dynamic> data, {int? currentUserId}) async {
  ...
  @override
  Future<Map<String, dynamic>> fetchCalendarMembership(int membershipId, {int? currentUserId}) async {
    final result = await get('/calendar_memberships/$membershipId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> createCalendarMembership(Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await post('/calendar_memberships', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateCalendarMembership(int membershipId, Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await put('/calendar_memberships/$membershipId', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<void> deleteCalendarMembership(int membershipId, {int? currentUserId}) async {
  ...
  @override
  Future<Map<String, dynamic>> fetchGroup(int groupId, {int? currentUserId}) async {
    final result = await get('/groups/$groupId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> createGroup(Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await post('/groups', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateGroup(int groupId, Map<String, dynamic> data, {int? currentUserId}) async {
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchGroupMemberships({int? groupId, int? userId}) async {
    final result = await get('/group_memberships', queryParams: {if (groupId != null) 'group_id': groupId, if (userId != null) 'user_id': userId});
    return List<Map<String, dynamic>>.from(result);
  }
  ...
  @override
  Future<Map<String, dynamic>> createGroupMembership(Map<String, dynamic> data) async {
    final result = await post('/group_memberships', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateGroupMembership(int membershipId, Map<String, dynamic> data) async {
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchRecurringConfigs({int? eventId, int? currentUserId}) async {
    final result = await get('/recurring_configs', queryParams: {if (eventId != null) 'event_id': eventId});
    return List<Map<String, dynamic>>.from(result);
  }

  @override
  Future<Map<String, dynamic>> fetchRecurringConfig(int configId, {int? currentUserId}) async {
    final result = await get('/recurring_configs/$configId', queryParams: {});
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> createRecurringConfig(Map<String, dynamic> data, {int? currentUserId}) async {
    final result = await post('/recurring_configs', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> updateRecurringConfig(int configId, Map<String, dynamic> data, {int? currentUserId}) async {
  ...
  @override
  Future<List<Map<String, dynamic>>> fetchUserBlocks({int? blockerUserId, int? blockedUserId}) async {
    final result = await get('/user_blocks', queryParams: {if (blockerUserId != null) 'blocker_user_id': blockerUserId, if (blockedUserId != null) 'blocked_user_id': blockedUserId});
    return List<Map<String, dynamic>>.from(result);
  }
  ...
  @override
  Future<Map<String, dynamic>> createUserBlock(Map<String, dynamic> data) async {
    final result = await post('/user_blocks', body: data);
    return result as Map<String, dynamic>;
  }

  @override
  Future<void> deleteUserBlock(int blockId, {required int currentUserId}) async {
    await delete('/user_blocks/$blockId');
  }

  @override
  Future<List<Map<String, dynamic>>> fetchEventBans({int? eventId, int? userId}) async {
    final result = await get('/event_bans', queryParams: {if (eventId != null) 'event_id': eventId, if (userId != null) 'user_id': userId});
    return List<Map<String, dynamic>>.from(result);
  }
...
class ApiClientFactory {
  ...
  static IApiClient get instance {
    if (_instance == null) {
      throw Exception('ApiClient not initialized. Call ApiClientFactory.initialize() first.');
    }
    return _instance!;
  }
}
