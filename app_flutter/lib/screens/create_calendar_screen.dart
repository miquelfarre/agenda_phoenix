...
class _CreateCalendarScreenState extends ConsumerState<CreateCalendarScreen> {
  ...
  Future<void> _createCalendar() async {
    ...
    try {
      await ref.read(calendarServiceProvider).createCalendar(name: name, description: description.isEmpty ? null : description, color: _selectedColor, isPublic: _isPublic);
