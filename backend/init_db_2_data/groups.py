...
def create_groups(db, private_users):
    ...
    group_uni = Group(
        id=4,
        name="Universidad UPC",
        description="Antiguos compañeros universidad",
        owner_id=miquel.id
    )
    ...
    group_vecinos = Group(
        id=5,
        name="Vecinos Gràcia",
        description="Vecinos del barrio",
    ...
    group_running = Group(
        id=6,
        name="Running Diagonal",
        description="Grupo de running",
        owner_id=all_users[8].id
    )
    ...
    group_yoga = Group(
        id=7,
        name="Yoga Matinal",
        description="Grupo de yoga",
        owner_id=all_users[11].id
    )
    ...
    return {
        'group_familia': group_familia,
        'group_primos': group_primos,
        'group_trabajo': group_trabajo,
        'group_uni': group_uni,
        'group_vecinos': group_vecinos,
        'group_running': group_running,
        'group_yoga': group_yoga,
        'all_groups': groups
    }
